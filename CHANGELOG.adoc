...
== {compare-url}/v0.5.1\...v0.6.0[0.6.0] - 2026-01-27

=== Added

* Add more archive formats for releases ({pull-request-url}/489[#489])

=== Changed

* Reject non-UTF-8 path on Unix ({pull-request-url}/527[#527])

== {compare-url}/v0.5.0\...v0.5.1[0.5.1] - 2025-07-28

=== Changed

* Stop building man pages when compiling a package
  ({pull-request-url}/424[#424])

== {compare-url}/v0.4.0\...v0.5.0[0.5.0] - 2025-06-12
